namespace AdventOfCode2019.Tests
{
    ...
    public class Day7Tests
    {
        ...
        public void TestExecute(int phaseSetting, int ampInput, int[] instructions, int expected)
        {
            ...
            var input = new int[] { phaseSetting, ampInput };
        ...
        public void TestNormalAmpCircuit(int[] phaseSequence, int[] instructions, int expected)
        {
        ...
        [DataRow(new int[] { 9, 7, 8, 5, 6 }, new int[] { 3, 52, 1001, 52, -5, 52, 3, 53, 1, 52, 56, 54, 1007, 54, 5, 55, 1005, 55, 26, 1001, 54, -5, 54, 1105, 1, 12, 1, 53, 54, 53, 1008, 54, 0, 55, 1001, 55, 1, 55, 2, 53, 55, 53, 4, 53, 1001, 56, -1, 56, 1005, 56, 6, 99, 0, 0, 0, 0, 10 }, 18216)]
        public void TestFeedbackAmpCircuit(int[] phaseSequence, int[] instructions, int expected)
        {
